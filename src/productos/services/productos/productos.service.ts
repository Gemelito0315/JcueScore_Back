...
import { CreateCategoriaDto, UpdateCategoriaDto, CreateSubcategoriaDto, UpdateSubcategoriaDto, CreateTipoProductoDto, UpdateTipoProductoDto } from '../../dtos/categoria.dto';
...
export class ProductosService {
    ...
    async findAll() {
        return await this.productoRepo.find({ relations: ['venue', 'productType'] });
    }
