...
export class UsersController {
    ...
    mineLoyalty(@Param('userId', ParseIntPipe) userId: number, @Body() payload: { coins: number, minutes: number }) {
        return this.usersService.mineLoyalty(userId, payload.coins || 10, payload.minutes || 60);
    }
