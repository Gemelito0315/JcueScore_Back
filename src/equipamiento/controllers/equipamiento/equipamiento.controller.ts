...
import { CreateEquipamientoDto, UpdateEquipamientoDto } from '../../dtos/equipamiento.dto';
...
export class EquipamientoController {
    ...
    update(@Param('id', ParseIntPipe) id: number, @Body() updateEquipamientoDto: UpdateEquipamientoDto) {
